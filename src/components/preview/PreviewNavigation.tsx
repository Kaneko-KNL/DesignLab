...
export function PreviewDrawer() {
    ...
    return (
        <div style={{ width: '100%' }}>
            <div style={{ fontSize: '11px', color: getContrastMutedColor(theme.colors.background), marginBottom: '8px', fontWeight: 500 }}>#Drawer</div>
            <div style={{
                width: '240px',
                height: '300px',
...
export function PreviewBottomSheet() {
    ...
    return (
        <div style={{ width: '100%' }}>
            <div style={{ fontSize: '11px', color: getContrastMutedColor(theme.colors.background), marginBottom: '8px', fontWeight: 500 }}>#Bottom Sheet</div>
            <div style={{
                width: '100%',
                maxWidth: '320px',
                backgroundColor: theme.colors.surface,
