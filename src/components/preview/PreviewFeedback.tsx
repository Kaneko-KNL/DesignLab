...
export function PreviewToast() {
    ...
    const { getContrastMutedColor } = require('@/lib/colors');
    return (
        <div style={{ width: '100%' }}>
            <div style={{ fontSize: '11px', color: getContrastMutedColor(theme.colors.background), marginBottom: '8px', fontWeight: 500 }}>#Toast</div>
            <motion.div
...
export function PreviewAlert() {
    ...
    return (
        <div style={{ width: '100%' }}>
            <div style={{ fontSize: '11px', color: getContrastMutedColor(theme.colors.background), marginBottom: '8px', fontWeight: 500 }}>#Alert</div>
            <div style={{
                padding: '16px',
...
export function PreviewModal() {
    ...
    return (
        <div style={{ width: '100%' }}>
            <div style={{ fontSize: '11px', color: getContrastMutedColor(theme.colors.background), marginBottom: '8px', fontWeight: 500 }}>#Modal</div>
            <div style={{
                position: 'relative',
                width: '100%',
                maxWidth: '400px',
...
export function PreviewTooltip() {
    ...
    return (
        <div style={{ width: '100%' }}>
            <div style={{ fontSize: '11px', color: getContrastMutedColor(theme.colors.background), marginBottom: '8px', fontWeight: 500 }}>#Tooltip</div>
